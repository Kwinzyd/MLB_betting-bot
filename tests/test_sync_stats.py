...
def _make_bdl_client(pitcher_stat, batter_stat):
    ...
    client.get_game_stats.return_value = [pitcher_stat, batter_stat]
    return client
...
def test_sync_stats_pitcher_log(mock_client_cls, mock_get_db, memory_db):
...
@patch('src.pipelines.sync_stats.get_db_connection')
@patch('src.pipelines.sync_stats.MLBStatsClient')
def test_sync_stats_batter_log(mock_client_cls, mock_get_db, memory_db):
...
@patch('src.pipelines.sync_stats.get_db_connection')
@patch('src.pipelines.sync_stats.MLBStatsClient')
def test_sync_stats_upserts_players(mock_client_cls, mock_get_db, memory_db):
