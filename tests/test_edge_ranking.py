...
def test_positive_edge_is_playable():
    ...
    result = rank_edge(proj, odds=1.87, side='over', devigged_prob=0.52)
...
def test_small_edge_not_playable():
    ...
    result = rank_edge(proj, odds=1.91, side='over', devigged_prob=0.50)
...
def test_day_to_day_is_playable():
    ...
    result = rank_edge(proj, odds=1.87, side='over', devigged_prob=0.52)
    # Day-to-Day is not in the reject list (only IL and Out are)
    assert result['is_playable'] is True
...
def test_under_side():
    ...
    result = rank_edge(proj, odds=1.87, side='under', devigged_prob=0.48)
